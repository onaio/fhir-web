...
export const AN_ERROR_OCCURRED = 'An Error Ocurred';
export const AND = 'and';
export const CASE_NUMBER = 'Case Number';
export const CONDITIONS_LABEL = 'Conditions';
export const DEFINITION_URI = 'Definition Uri';
...
export const FOCUS_CLASSIFICATION_LABEL = 'Focus Classification';
...
export const MDA_POINT_TITLE = 'MDA Point';
...
export const SELECT_PLACHOLDER = 'Select %s';
