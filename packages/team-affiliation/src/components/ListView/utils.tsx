    ...
    <>
      <Button
        ...
        onClick={() => {
          ...
          record.setExistingAffiliations(record.existingAffiliations);
          record.setAssignedLocAndOrgs({
...
export const columnsFactory = (langObj: Lang = lang): Column<TableData>[] => {
  const columns: Column<TableData>[] = [
    ...
    {
      title: langObj.ORGANIZATION,
      dataIndex: 'assignedOrgs',
...
export const TeamAffiliationLoading = () => {
