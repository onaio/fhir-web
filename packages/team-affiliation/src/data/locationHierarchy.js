[
  {
    resourceType: 'Bundle',
    id: 'fae0faf4-4ab1-4854-b3e1-754b1c3448ef',
    meta: {
      lastUpdated: '2021-11-22T12:34:58.738+00:00',
    },
    type: 'searchset',
    total: 1,
    link: [
      {
        relation: 'self',
        url:
          'http://fhir.labs.smartregister.org/fhir/LocationHierarchy?_format=json&identifier=c3ff106e-91cb-4346-b45f-d7ad5346af5a',
      },
    ],
    entry: [
      {
        fullUrl:
          'http://fhir.labs.smartregister.org/fhir/LocationHierarchy/Location Resource : 304',
        resource: {
          resourceType: 'LocationHierarchy',
          id: 'Location Resource : 304',
          meta: {
                ...
                treeNode: [
                  {
                    ...
                    node: {
                      ...
                      meta: {
                        versionId: '3',
                        lastUpdated: '2021-07-19T12:15:29.925+00:00',
                        source: '#0d3cfe5087918983',
                      },
                      identifier: [
                        {
                          use: 'official',
  ...
  {
    resourceType: 'Bundle',
    id: '50413109-b858-4155-a05d-899873ba6af2',
    meta: {
      lastUpdated: '2021-11-22T12:51:56.038+00:00',
    },
    type: 'searchset',
    total: 1,
    link: [
      {
        relation: 'self',
        url:
          'http://fhir.labs.smartregister.org/fhir/LocationHierarchy?_format=json&identifier=93bc9c3d-6321-41b0-9b93-1275d7114e22',
      },
    ],
    entry: [
      {
        fullUrl:
          'http://fhir.labs.smartregister.org/fhir/LocationHierarchy/Location Resource : 303',
        resource: {
          resourceType: 'LocationHierarchy',
          id: 'Location Resource : 303',
          meta: {
            profile: ['http://hl7.org/fhir/profiles/custom-resource'],
          },
          LocationHierarchyTree: {
                                            ...
                                            children: [
                                              {
                                                ...
                                                treeNode: {
                                                  ...
                                                  node: {
                                                    ...
                                                    meta: {
                                                      versionId: '1',
                                                      lastUpdated: '2021-10-26T07:48:19.889+00:00',
                                            ...
                                            children: [
                                              {
                                                ...
                                                treeNode: {
                                                  ...
                                                  node: {
                                                    ...
                                                    meta: {
                                                      versionId: '2',
                                                      lastUpdated: '2021-10-26T07:50:53.540+00:00',
                                                              ...
                                                              children: [
                                                                {
                                                                  ...
                                                                  treeNode: {
                                                                    ...
                                                                    children: [
                                                                      {
                                                                        childId: 'Location/3776',
                                                                        treeNode: {
                                                                          nodeId: 'Location/3776',
                                                                          label:
