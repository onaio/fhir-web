...
export const allAffiliations = {
  resourceType: 'Bundle',
  id: '3a5c36b6-7eec-4d5d-aaf9-14e5b119f990',
  meta: {
    lastUpdated: '2022-03-09T13:25:20.557+00:00',
  },
  type: 'searchset',
  total: 4,
  link: [
    {
      relation: 'self',
      url: 'https://fhir.labs.smartregister.org:443/fhir/OrganizationAffiliation?_format=json',
    },
  ],
  entry: [
    {
      fullUrl: 'https://fhir.labs.smartregister.org:443/fhir/OrganizationAffiliation/1528',
      resource: {
    ...
    },
    {
      ...
      resource: {
        ...
        meta: {
          versionId: '1',
          lastUpdated: '2021-08-26T07:52:22.784+00:00',
          source: '#465195a957151ada',
        },
        identifier: [
          {
            use: 'official',
            value: '87e7be04-8072-4ffd-90f3-dc12ee28afef',
          },
        ],
        active: true,
        organization: {
          reference: 'Organization/363',
          display: 'Test Team 4',
        },
        location: [
          {
...
export const allOrgs = {
  resourceType: 'Bundle',
  id: '10467e23-8f81-4aae-bbb4-53fe35d899d5',
  meta: {
    lastUpdated: '2022-03-09T13:27:00.396+00:00',
  },
  type: 'searchset',
  total: 225,
  link: [
    ...
    {
      relation: 'next',
      url: 'https://fhir.labs.smartregister.org:443/fhir?_getpages=10467e23-8f81-4aae-bbb4-53fe35d899d5&_getpagesoffset=5&_count=5&_format=json&_pretty=true&_bundletype=searchset',
    },
  ],
  entry: [
    {
      fullUrl: 'https://fhir.labs.smartregister.org:443/fhir/Organization/362',
      resource: {
    ...
    {
      fullUrl: 'https://fhir.labs.smartregister.org:443/fhir/Organization/void',
      resource: {
        resourceType: 'Organization',
        id: 'void',
        meta: {
...
export const createdAffiliation1 = {
  ...
  location: [{ reference: 'Location/303', display: 'Ona Office Sub Location' }],
};

export const createdAffiliation2 = {
  resourceType: 'OrganizationAffiliation',
  id: '1528',
  meta: {
    versionId: '2',
  ...
  identifier: [{ use: 'official', value: '317fddbb-132e-498c-b672-b18802f9deaf' }],
  active: true,
  organization: { reference: 'Organization/362', display: 'Test Team 3' },
  location: [
    { reference: 'Location/304', display: 'Part Of Sub Location' },
    { reference: 'Location/739', display: 'Test Loc 1' },
    { reference: 'Location/971', display: 'Arundel mobile clinic' },
  ],
};
