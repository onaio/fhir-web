...
export const sampleData = [
  {
    ...
    first_name: 'Kearney',
    last_name: 'Rizzello',
    email: 'krizzello0@walmart.com',
    gender: 'Male',
    ip_address: '198.197.194.238',
  },
  {
    id: 2,
    first_name: 'Melina',
    last_name: 'Sherwin',
    email: 'msherwin1@rakuten.co.jp',
    gender: 'Female',
    ip_address: '146.184.11.4',
  },
  {
    id: 3,
    first_name: 'Stillmann',
    last_name: 'Jacobowicz',
    email: 'sjacobowicz2@vimeo.com',
    gender: 'Male',
    ip_address: '180.237.208.205',
  },
  {
    id: 4,
    first_name: 'Reamonn',
    last_name: 'Punter',
    email: 'rpunter3@nps.gov',
    gender: 'Male',
    ip_address: '60.148.165.38',
  },
  {
    id: 5,
    first_name: 'Michele',
    last_name: 'La Batie',
    email: 'mlabatie4@discovery.com',
    gender: 'Genderqueer',
    ip_address: '35.251.187.180',
  },
  {
    id: 6,
    first_name: 'Genny',
    last_name: 'Reggiani',
    email: 'greggiani5@tmall.com',
    gender: 'Female',
    ip_address: '227.93.216.116',
  },
  {
    id: 7,
    first_name: 'Feodora',
    last_name: 'Ellingham',
    email: 'fellingham6@ca.gov',
    gender: 'Female',
    ip_address: '195.88.42.13',
  },
  {
    id: 8,
    first_name: 'Ailsun',
    last_name: 'Krauze',
    email: 'akrauze7@statcounter.com',
    gender: 'Female',
    ip_address: '26.107.123.94',
  },
  {
    id: 9,
    first_name: 'Jelene',
    last_name: 'Casement',
    email: 'jcasement8@gov.uk',
    gender: 'Female',
    ip_address: '249.204.221.30',
  },
  {
    id: 10,
    first_name: 'Konrad',
    last_name: 'Puddle',
    email: 'kpuddle9@example.com',
    gender: 'Male',
    ip_address: '137.140.236.67',
  },
  {
    id: 11,
    first_name: 'Oralla',
    last_name: 'Golledge',
    email: 'ogolledgea@thetimes.co.uk',
    gender: 'Female',
    ip_address: '22.28.95.41',
  },
  {
    id: 12,
    first_name: 'Link',
    last_name: 'McCorry',
    email: 'lmccorryb@sakura.ne.jp',
    gender: 'Male',
    ip_address: '209.195.215.111',
  },
  {
    id: 13,
    first_name: 'Clark',
    last_name: 'Krzyzanowski',
    email: 'ckrzyzanowskic@facebook.com',
    gender: 'Male',
    ip_address: '95.145.90.228',
  },
  {
    id: 14,
    first_name: 'Derick',
    last_name: 'Gwilym',
    email: 'dgwilymd@si.edu',
    gender: 'Male',
    ip_address: '17.143.231.151',
  },
  {
    id: 15,
    first_name: 'Rees',
    last_name: 'Whysall',
    email: 'rwhysalle@instagram.com',
    gender: 'Bigender',
    ip_address: '120.203.27.246',
  },
  {
    id: 16,
    first_name: 'Blakelee',
    last_name: 'Itzkowicz',
    email: 'bitzkowiczf@dmoz.org',
    gender: 'Female',
    ip_address: '223.24.251.3',
  },
  {
    id: 17,
    first_name: 'Gill',
    last_name: 'Dominka',
    email: 'gdominkag@histats.com',
    gender: 'Female',
    ip_address: '108.91.213.240',
  },
  {
    id: 18,
    first_name: 'Lorinda',
    last_name: 'Deegin',
    email: 'ldeeginh@dropbox.com',
    gender: 'Female',
    ip_address: '47.83.169.139',
  },
  {
    id: 19,
    first_name: 'Rozanna',
    last_name: 'Potte',
    email: 'rpottei@amazon.co.uk',
    gender: 'Female',
    ip_address: '35.130.204.193',
  },
  {
    id: 20,
    first_name: 'Iseabal',
    last_name: 'Tregonna',
    email: 'itregonnaj@microsoft.com',
    gender: 'Female',
    ip_address: '90.170.7.245',
  },
];
