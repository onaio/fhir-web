...
var TableActions = function TableActions(props) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(_antd.Space, {
    size: "middle"
  }, React.createElement(_reactRouterDom.Link, {
    to: "".concat(_constants.URL_USER_EDIT, "/").concat(record.id),
    key: "actions"
  }, "Edit"), React.createElement(_antd.Popconfirm, {
    title: "Are you sure delete this user?",
    okText: "Yes",
    cancelText: "No",
    onConfirm: function onConfirm() {
      return (0, _utils.deleteUser)(removeKeycloakUsersCreator, accessToken, keycloakBaseURL, record.id, isLoadingCallback);
    }
  }, React.createElement(_reactRouterDom.Link, {
    to: "#"
  }, "Delete"))));
