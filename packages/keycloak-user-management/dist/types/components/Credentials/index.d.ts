...
export declare const ConnectedUserCredentials: import("react-redux").ConnectedComponent<React.FC<CredentialsPropsTypes>, Pick<CredentialsPropsTypes, "location" | "match" | "keycloakBaseURL" | "serviceClass" | "history" | "staticContext"> & CredentialsProps & RouteComponentProps<CredentialsRouteParams, import("react-router").StaticContext, unknown>>;
