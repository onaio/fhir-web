...
export declare const ConnectedCreateEditUsers: import("react-redux").ConnectedComponent<React.FC<PropsTypes>, Pick<PropsTypes, "location" | "serviceClass" | "history" | "match" | "staticContext"> & EditUserProps & RouteComponentProps<RouteParams, import("react-router").StaticContext, unknown>>;
