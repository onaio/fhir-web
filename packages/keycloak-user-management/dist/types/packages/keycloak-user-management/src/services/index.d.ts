...
export declare function getDefaultHeaders(accept?: string, authorizationType?: string, contentType?: string): IncomingHttpHeaders;
...
export declare class OpenSRPService extends OpenSRPServiceWeb {
    constructor(endpoint: string, baseURL?: string, getPayload?: typeof getPayloadOptions);
