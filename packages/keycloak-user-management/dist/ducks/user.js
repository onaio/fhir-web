...
var getUsersByUsername = function getUsersByUsername() {
  return (0, _reselect.createSelector)(getKeycloakUsersArray, getUsername, function (
    usersArray,
    username
  ) {
    return username
...
var getKeycloakUsersByIds = function getKeycloakUsersByIds() {
  return (0, _reselect.createSelector)(
    ...
    function (usersById, ids, usersArray) {
      if (ids === undefined) {
        return usersArray;
      }
...
var makeKeycloakUsersSelector = function makeKeycloakUsersSelector() {
  return (0, _reselect.createSelector)(getKeycloakUsersByIds(), getUsersByUsername(), function (
    arr1,
    arr2
  ) {
