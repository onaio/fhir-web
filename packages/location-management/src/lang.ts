...
export const LOCATION_UNIT_GROUP_MANAGEMENT = i18n.t('Location Unit Group Management');
export const ADD_LOCATION_UNIT = i18n.t('Add Location Unit');
export const EDIT_LOCATION_UNIT = i18n.t('Edit Location Unit');
export const ADD_LOCATION_UNIT_GROUP = i18n.t('Add Location Unit Group');
export const EDIT_LOCATION_UNIT_GROUP = i18n.t('Edit Location Unit Group');
export const SEARCH = i18n.t('Search');

export const SUCCESSFULLY_CREATED_LOCATION = i18n.t('Location was successfully created');
export const SUCCESSFULLY_UPDATED_LOCATION = i18n.t('Location was successfully updated');
export const CANCEL = i18n.t('Cancel');
export const LOCATION_ACTIVE_STATUS_LABEL = i18n.t('Active');
export const LOCATION_INACTIVE_STATUS_LABEL = i18n.t('Inactive');
export const LOCATION_JURISDICTION_LABEL = i18n.t('Jurisdiction');
export const LOCATION_STRUCTURE_LABEL = i18n.t('Service point');
export const INSTANCE_LABEL = i18n.t('Instance');
export const ID_LABEL = i18n.t('Id');
export const USERNAME_LABEL = i18n.t('username');
export const PARENT_LABEL = i18n.t('Parent');
export const NAME_LABEL = i18n.t('Name');
export const STATUS_LABEL = i18n.t('Status');
export const LOCATION_CATEGORY_LABEL = i18n.t('Location category');
export const TYPE_LABEL = i18n.t('Type');
export const SERVICE_TYPES_LABEL = i18n.t('Type');
...
export const GEOMETRY_PLACEHOLDER = i18n.t('</> JSON');
...
export const TYPE = i18n.t('Type');
export const USERNAME = i18n.t('Username');
export const VERSION = i18n.t('Version');
export const SYNC_STATUS = i18n.t('Sync status');
export const LEVEL = i18n.t('Level');
export const LOCATION_NAME = i18n.t('Location Name');
export const DESCRIPTION = i18n.t('Description');
export const ENTER_LOCATION_GROUP_NAME = i18n.t('Enter a location group name');
