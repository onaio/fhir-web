...
export const BEDNET_DISTRIBUTION_CODE = 'bednet_distribution';
export const BLOOD_SCREENING_CODE = 'blood_screening';
export const CASE_CONFIRMATION_CODE = 'case_confirmation';
export const RACD_REGISTER_FAMILY_CODE = 'racd_register_family';
export const LARVAL_DIPPING_CODE = 'larval_dipping';
export const MOSQUITO_COLLECTION_CODE = 'mosquito_collection';
export const MDA_POINT_DISPENSE_CODE = 'mda_dispense';
export const MDA_POINT_ADVERSE_EFFECTS_CODE = 'mda_adverse_event(s)';
export const MDA_ADHERENCE_CODE = 'mda_adherence';
