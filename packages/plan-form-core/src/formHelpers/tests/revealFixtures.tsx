  ...
  activities: [
    {
      ...
      goalDue: parseISO(`2019-08-16${defaultEnvConfig.defaultTime}`),
      goalPriority: 'medium-priority',
      goalValue: 90,
      timingPeriodEnd: parseISO(`2019-08-16${defaultEnvConfig.defaultTime}`),
      timingPeriodStart: parseISO(`2019-08-09${defaultEnvConfig.defaultTime}`),
    },
  ],
  caseNum: '',
