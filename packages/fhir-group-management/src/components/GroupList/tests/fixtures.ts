...
export const groupsPage2 = {
  ...
  link: [
    {
      relation: 'self',
      url: 'https://fhir.labs.smartregister.org:443/fhir/Group/?_count=2&_format=json&_getpageoffset=2',
    },
    {
      relation: 'next',
      url: 'https://fhir.labs.smartregister.org:443/fhir?_getpages=d5221d0e-158c-4f2c-8a4f-94f5853e4d60&_getpagesoffset=2&_count=2&_format=json&_pretty=true&_bundletype=searchset',
...
export const groupsPageSearch = {
  resourceType: 'Bundle',
  id: '6ad7a3b4-3e74-47fe-9c0b-c0001b9017d7',
  meta: {
  ...
  link: [
    {
      relation: 'self',
      url: 'https://fhir.labs.smartregister.org:443/fhir/Group/?_count=2&_format=json&_getpageoffset=2&_name%3Acontains=Jan27Test',
    },
    {
      relation: 'next',
      url: 'https://fhir.labs.smartregister.org:443/fhir?_getpages=6ad7a3b4-3e74-47fe-9c0b-c0001b9017d7&_getpagesoffset=2&_count=2&_format=json&_pretty=true&_bundletype=searchset',
    },
  ],
  entry: [
    {
