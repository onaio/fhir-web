...
var OpenSRPService = (function () {
  function OpenSRPService() {
    var baseURL =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : OPENSRP_API_BASE_URL;
    var endpoint = arguments.length > 1 ? arguments[1] : undefined;
    var getPayload =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : getFetchOptions;
    var signal =
      arguments.length > 3 && arguments[3] !== undefined
        ? arguments[3]
                    ...
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        payload = _objectSpread(
                          _objectSpread({}, this.getOptions(this.signal, method)),
                          {},
                          {
