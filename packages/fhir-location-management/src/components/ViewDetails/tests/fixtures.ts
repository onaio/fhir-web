...
export const kiambuCountyInclude = {
  ...
  entry: [
    ...
    {
      fullUrl:
        'https://fhir.labs.smartregister.org/fhir/Location/d9d7aa7b-7488-48e7-bae8-d8ac5bd09334',
...
export const trueKenyaInclude = {
  ...
  entry: [
    {
      fullUrl:
        'https://fhir.labs.smartregister.org/fhir/Location/fe9e549b-a427-4db6-aad9-edade11b6e6a',
      resource: {
        resourceType: 'Location',
