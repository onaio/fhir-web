...
const fetchBaseClients = fetchActionCreatorFactory<ANCClientType>(customReducerName, 'baseEntityId');
...
describe('reducers/clients', () => {
    ...
    it('fetches clients correctly', () => {
        ...
        expect(getBaseClientById(store.getState(), '71ad460c-bf76-414e-9be1-0d1b2cb1bce8')).toEqual(client1);
        expect(getAllANCById(store.getState())).toEqual({
        ...
        expect(getANCById(store.getState(), 'f1a3e6ee-58d2-4d5c-9588-5e2658abe21c')).toEqual(ANCClient1);
    });
