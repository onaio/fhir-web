...
describe('opensrp-plans/assignmentTable', () => {
  ...
  it('renders correctly', async () => {
    ...
    expect(wrapper.text()).toMatchInlineSnapshot(
      `"Assigned areasAssigned teamsActions9b5dd829-89de-45a5-98f2-fd37787ae949, 6bb05db0-730b-409b-991d-4abfe6a59ea1, 1b14ff5b-1f24-4b50-a59a-33cef0ed7bfb, 7d150b42-11e7-4362-8d0d-1a8ef506c754, 9fb0f2cf-7836-4557-a908-4b8cd628d193Edit areasEdit teams"`
    );
    wrapper.unmount();
  });
  ...
  it('renders correctly when there is data', async () => {
    ...
    expect(wrapper.text()).toMatchInlineSnapshot(
      `"Assigned areasAssigned teamsActionsIITANANGA, OKASHANDJAOna testOrgEdit areasEdit teamsIITANANGATest Test TeamEdit areasEdit teamsOKASHANDJANAIMA old test teamEdit areasEdit teamsIIYALA N.6, OKANKETE-2, OSHIPUMBU MAKILINDIDI NO 2-1Edit areasEdit teams"`
    );
    wrapper.unmount();
  });
  ...
  it('test plan teams assignment', async () => {
    ...
    // check the rendered output
    expect(wrapper.text()).toMatchInlineSnapshot(
      `"Assigned areasAssigned teamsActionsIITANANGAEdit areasEdit teams"`
    );
