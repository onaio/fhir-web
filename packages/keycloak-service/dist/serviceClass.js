...
exports.KeycloakService = exports.customFetch = exports.KEYCLOAK_API_BASE_URL = void 0;
...
function getDefaultHeaders() {
  ...
  console.log('store??', _store.store.getState());
  return {
    accept: accept,
    authorization: "".concat(authorizationType, " ").concat((0, _store.getAccessToken)(_store.store.getState())),
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                url = KeycloakService.getURL(this.generalURL, params);
              ...
              case 10:
                defaultMessage = "KeycloakAPIService create on ".concat(this.endpoint, " failed, HTTP status ").concat(response === null || response === void 0 ? void 0 : response.status);
                _context2.next = 13;
