          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                payload = _objectSpread(_objectSpread({}, this.getOptions(this.signal, this.accessToken, method)), {}, {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 5;
                return customFetch(url, this.getOptions(this.signal, this.accessToken, method));
