...
var KeycloakAPIService = (function () {
  function KeycloakAPIService(accessToken) {
    var baseURL =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : KEYCLOAK_API_BASE_URL;
                ...
                function _callee2$(_context2) {
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 10:
                        defaultMessage = 'KeycloakAPIService create on '
                ...
                function _callee3$(_context3) {
                  while (1) {
                    switch ((_context3.prev = _context3.next)) {
                      ...
                      case 11:
                        defaultMessage = 'KeycloakAPIService read on '
                          .concat(this.endpoint, ' failed, HTTP status ')
                ...
                function _callee4$(_context4) {
                  while (1) {
                    switch ((_context4.prev = _context4.next)) {
                      ...
                      case 10:
                        defaultMessage = 'KeycloakAPIService update on '
                          .concat(this.endpoint, ' failed, HTTP status ')
                          .concat(response.status);
                        _context4.next = 13;
                        return (0, _errors.throwHTTPError)(response, defaultMessage);
                ...
                function _callee5$(_context5) {
                  while (1) {
                    switch ((_context5.prev = _context5.next)) {
                      ...
                      case 11:
                        defaultMessage = 'KeycloakAPIService list on '
                          .concat(this.endpoint, ' failed, HTTP status ')
                          .concat(response.status);
                        _context5.next = 14;
                        return (0, _errors.throwHTTPError)(response, defaultMessage);
                ...
                function _callee6$(_context6) {
                  while (1) {
                    switch ((_context6.prev = _context6.next)) {
                      ...
                      case 9:
                        defaultMessage = 'KeycloakAPIService delete on '
                          .concat(this.endpoint, ' failed, HTTP status ')
                          .concat(response.status);
                        _context6.next = 12;
                        return (0, _errors.throwHTTPError)(response, defaultMessage);
...
var KeycloakService = (function (_KeycloakAPIService) {
  ...
  function KeycloakService(accessToken, endpoint) {
    var baseURL =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : KEYCLOAK_API_BASE_URL;
    var getPayload =
      arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : getFetchOptions;
              ...
              function _callee7$(_context7) {
                while (1) {
                  switch ((_context7.prev = _context7.next)) {
                    case 0:
                      params = _args7.length > 1 && _args7[1] !== undefined ? _args7[1] : null;
                      method = _args7.length > 2 && _args7[2] !== undefined ? _args7[2] : 'GET';
                      url = KeycloakService.getURL(
                        ''.concat(this.generalURL, '/').concat(id),
                        params
                      );
                      _context7.next = 5;
