...
export declare class KeycloakAPIService {
     ...
     */
    constructor(accessToken: string, baseURL: string | undefined, endpoint: string, getPayload?: typeof getFetchOptions, signal?: AbortSignal);
...
export declare class KeycloakService extends KeycloakAPIService {
    constructor(accessToken: string, endpoint: string, baseURL?: string, getPayload?: typeof getFetchOptions);
