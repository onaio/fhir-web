  ...
  link: [
    {
      relation: 'self',
      url:
        'http://fhir.labs.smartregister.org/fhir/Questionnaire/_search?_count=2&_format=json&_getpagesoffset=0',
    },
    {
      relation: 'next',
      url:
        'http://fhir.labs.smartregister.org/fhir?_getpages=c19781e5-ebaa-45c2-bc9b-c64b502a5672&_getpagesoffset=2&_count=2&_format=json&_pretty=true&_bundletype=searchset',
    },
  ],
  entry: [
    {
  ...
  link: [
    {
      relation: 'self',
      url:
        'http://fhir.labs.smartregister.org/fhir/Questionnaire/_search?_count=2&_format=json&_getpagesoffset=2',
    },
    {
      relation: 'next',
      url:
        'http://fhir.labs.smartregister.org/fhir?_getpages=91cb3828-8e1f-4063-b8f3-552b111f917d&_getpagesoffset=4&_count=2&_format=json&_pretty=true&_bundletype=searchset',
    },
    {
      relation: 'previous',
      url:
        'http://fhir.labs.smartregister.org/fhir?_getpages=91cb3828-8e1f-4063-b8f3-552b111f917d&_getpagesoffset=0&_count=2&_format=json&_pretty=true&_bundletype=searchset',
    },
  ],
  entry: [
    {
  ...
  link: [
    {
      relation: 'self',
      url:
        'http://fhir.labs.smartregister.org/fhir/QuestionnaireResponse/_search?_count=2&_format=json&_getpagesoffset=0&questionnaire=3440',
    },
    {
      relation: 'next',
      url:
        'http://fhir.labs.smartregister.org/fhir?_getpages=a79f8b31-f977-4e9b-a011-9ab38bcf098a&_getpagesoffset=2&_count=2&_format=json&_pretty=true&_bundletype=searchset',
    },
  ],
  entry: [
    {
  ...
  link: [
    {
      relation: 'self',
      url:
        'http://fhir.labs.smartregister.org/fhir/QuestionnaireResponse/_search?_count=2&_format=json&_getpagesoffset=2&questionnaire=3440',
    },
    {
      relation: 'next',
      url:
        'http://fhir.labs.smartregister.org/fhir?_getpages=cf05879e-eb2d-49b9-bbf9-af9ba202ce2e&_getpagesoffset=4&_count=2&_format=json&_pretty=true&_bundletype=searchset',
    },
    {
      relation: 'previous',
      url:
        'http://fhir.labs.smartregister.org/fhir?_getpages=cf05879e-eb2d-49b9-bbf9-af9ba202ce2e&_getpagesoffset=0&_count=2&_format=json&_pretty=true&_bundletype=searchset',
    },
  ],
  entry: [
    {
