...
const defaultRoles = {
  USERS: `${CardStatus.ROLE_EDIT_KEYCLOAK_USERS},${CardStatus.ROLE_VIEW_KEYCLOAK_USERS}`,
  PLANS: CardStatus.ROLE_VIEW_KEYCLOAK_USERS,
  LOCATIONS: CardStatus.ROLE_VIEW_KEYCLOAK_USERS,
  CARD_SUPPORT: CardStatus.ROLE_VIEW_KEYCLOAK_USERS,
  INVENTORY: CardStatus.ROLE_VIEW_KEYCLOAK_USERS,
  TEAMS: CardStatus.ROLE_VIEW_KEYCLOAK_USERS,
  PRODUCT_CATALOGUE: CardStatus.ROLE_VIEW_KEYCLOAK_USERS,
  FORM_CONFIGURATION: CardStatus.ROLE_VIEW_KEYCLOAK_USERS,
};
...
export const OPENSRP_ROLES =
  JSON.parse(process.env.REACT_APP_OPENSRP_ROLES as string) || defaultRoles;
