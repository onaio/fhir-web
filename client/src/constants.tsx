...
export const URL_UPLOAD_JSON_VALIDATOR = URL_ADMIN + '/json-validators/upload';
export const URL_JSON_VALIDATOR_LIST = URL_ADMIN + '/json-validators';
export const URL_DRAFT_FILE_LIST = URL_ADMIN + '/drafts';
export const URL_UPLOAD_DRAFT_FILE = URL_ADMIN + '/drafts/upload';
export const URL_MANIFEST_RELEASE_LIST = URL_ADMIN + '/releases';
