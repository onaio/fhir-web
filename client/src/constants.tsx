...
export const URL_DOWNLOAD_CLIENT_DATA = '/download-client-data';
...
export const URL_LOCATION_TAG_ADD = '/location/group/add';
export const URL_LOCATION_TAG_EDIT = '/location/group/edit';
